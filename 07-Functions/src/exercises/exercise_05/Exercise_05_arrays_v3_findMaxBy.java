 ...
 *
 * En esta versión utilizamos una búsqueda de la posición del valor máximo no repetido en un array de valores
 *
 * Lo usamos para reimplementar la función findWinnerBy
 *
 * ya que de lo que se trata es de encontrar la posición del máximo (tirada de dado, puntos) sin que haya empates,
 * es decir, que sea el máximo y sea único (no se repita)
 *
 */
